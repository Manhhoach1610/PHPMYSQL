...
<?php 
    ...
    try {
        ...
        $mail->Username = 'manhhoach2k1@gmail.com';
        $mail->Password = 'Manhhoach778899';
        $mail->SMTPSecure = 'tls';      
           // Enable TLS encryption, `ssl` also accepted
        $mail->Port = 587;                   // TCP port to connect to
        $mail->charset = 'UTF-8'; // Charset
        $mail->setFrom('vanyellow1211@gmail.com
        '); // From email
        $mail->addAddress('mạnh hoạch Hà Nam', 'Mạnh Hoạch'); // Email address
