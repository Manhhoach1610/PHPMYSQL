	...
	<div id="contents">
		<div class="wrapper clearfix">
			...
			<?php 
					include ('control.php');
					$getdata = new data();
                    $id_blog = $_GET['content'];  // lay giá trị content truyền từ trang blog vào
					$select_blog_id = $getdata->select_blog_id($id_blog); //goi function select_blog_id trong class data
			?>
				<h1>Blog</h1>
				<ul class="list">
					<?php
						foreach ($select_blog_id as $se)
					?>
					<li>
						<span class="time">
							<?php 
						...
						<a href="blog.php" class="more">Back to blog&gt;&gt;</a>
					</li>
